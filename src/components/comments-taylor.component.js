...
const CommentsTaylorComponent = ({ id }) => {
    const [comentarios, setComentarios] = useState([]);
    const [commentText, setCommentText] = useState([]);
    const uri = "https://backend-mongo-service-kafka-lilliamwitham.cloud.okteto.net/api/comments"
...
export default CommentsTaylorComponent;
